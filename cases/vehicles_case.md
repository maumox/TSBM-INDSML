...
1.	Data Exploration:
  *	Begin by exploring the data to understand its structure, distributions, and any potential relationships. Does it make sense that larger cars tend to be heavier and less fuel-efficient?
  *	Create visualizations (e.g., scatter plots) to see if you can spot any patterns between weight and MPG.
2.	Building Predictive Models:
  *	Model the relationship between weight and MPG. What does the data suggest about the impact of weight on MPG?
3.	Model Evaluation:
  *	Evaluate the performance of your models. How does the model’s prediction compare to real-world expectations for cars of different sizes and weights?
  *	Make sure to assess performance using the proper metric.
4.	Business Application:
  *	Based on your findings, provide actionable insights to the company. How can they use these predictions in future vehicle design? For example, if the company wants a car that weighs under 3,000 pounds and achieves over 30 MPG, can they use the model to find the optimal weight?
